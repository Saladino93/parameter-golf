...
class Hyperparameters:
    ...
    logit_softcap: float = float(
        os.environ.get("LOGIT_SOFTCAP", 30.0)
    )  # (tanh(x/30)*30), exists precisely because attention scores can explode in bf16,  the softcap clamps them before they hit the mantissa precision cliff
